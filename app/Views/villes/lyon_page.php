...
<h1 class="city-title">Bienvenue au grand Hôtel Royal de Lyon</h1>

<!-- Carrousel d'images de l'hôtel -->
<div class="carousel">
    <button class="prev" onclick="moveHotelSlide(-1)">❮</button>
    <div class="slides">
        <img src="<?= base_url('img/hotel_lyon1.jpg') ?>" class="slide" />
        <img src="<?= base_url('img/hotel_lyon2.jpg') ?>" class="slide" />
    </div>
...
<div class="bubbles-container">
    ...
    $rooms = [
        ...
        [
            'type' => 'Suite',
            'images' => ['chambre_lyon_4_1.jpg', 'chambre_lyon_4_2.jpg', 'chambre_lyon_4_3.jpg'],
            'description' => [
        ...
        [
            ...
            'images' => ['chambre_lyon_5_1.jpg', 'chambre_lyon_5_2.jpg', 'chambre_lyon_5_3.jpg'],
            'description' => [
