...
<h1 class="city-title">Bienvenue au grand Hôtel de Lille</h1>

<!-- Carrousel d'images de l'hôtel -->
<div class="carousel">
    <button class="prev" onclick="moveHotelSlide(-1)">❮</button>
    <div class="slides">
        <img src="<?= base_url('img/hotel_lille1.jpg') ?>" class="slide" />
        <img src="<?= base_url('img/hotel_lille2.webp') ?>" class="slide" />
    </div>
...
<div class="bubbles-container">
    ...
    $rooms = [
        ...
        [
            'type' => 'Suite',
            'images' => ['chambre_lille_4.1.webp', 'chambre_lille_4.2.webp', 'chambre_lille_4.3.webp'],
            'description' => [
        ...
        [
            ...
            'images' => ['chambre_lille_5.1.jpg', 'chambre_lille_5.2.jpg', 'chambre_lille_5.3.jpg'],
            'description' => [
