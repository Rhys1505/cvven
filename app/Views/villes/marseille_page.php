...
<h1 class="city-title">Bienvenue au grand Hôtel du vieux port Marseille</h1>

<!-- Carrousel d'images de l'hôtel -->
<div class="carousel">
    <button class="prev" onclick="moveHotelSlide(-1)">❮</button>
    <div class="slides">
        <img src="<?= base_url('img/hotel.marseille.jpg') ?>" class="slide" />
        <img src="<?= base_url('img/hotel.marseille1.jpg') ?>" class="slide" />
    </div>
...
<div class="bubbles-container">
    ...
    $rooms = [
        [
            'type' => 'Chambre Double',
            'images' => ['chambre_marseille_1_1.jpg', 'chambre_marseille_1_2.jpg', 'chambre_marseille_1_3.jpg'],
            'description' => [
                'Lit double',
                'Climatisation',
                'Wi-Fi gratuit',
        ...
        [
            'type' => 'Chambre Triple',
            'images' => ['chambre_marseille_2_1.webp', 'chambre_marseille_2_2.wepb', 'chambre_marseille_2_3.webp'],
            'description' => [
                'Lit simple',
                'Climatisation',
                'Wi-Fi gratuit',
        ...
        [
            'type' => 'Suite',
            'images' => ['chambre_marseille_4_1.jpg', 'chambre_marseille_4_2.jpg', 'chambre_marseille_4_2.jpg'],
            'description' => [
        ...
        [
            ...
            'images' => ['chambre_marseille_5_1.jpg', 'chambre_marseille_45.jpg', 'chambre_marseille_5_3.jpg'],
            'description' => [
