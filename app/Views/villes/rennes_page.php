...
<h1 class="city-title">Bienvenue au grand Hôtel Mercure de Rennes</h1>

<!-- Carrousel d'images de l'hôtel -->
<div class="carousel">
    <button class="prev" onclick="moveHotelSlide(-1)">❮</button>
    <div class="slides">
        <img src="<?= base_url('img/hotel_rennes1.jpg') ?>" class="slide" />
        <img src="<?= base_url('img/hotel_rennes2.jpg') ?>" class="slide" />
    </div>
...
<div class="bubbles-container">
    ...
    $rooms = [
        ...
        [
            'type' => 'Suite',
            'images' => ['chambre_rennes_4_1.webp', 'chambre_rennes_4_2.jpg', 'chambre_rennes_4_3.jpg'],
            'description' => [
        ...
        [
            ...
            'images' => ['chambre_rennes_5_1.jpg', 'chambre_rennes_5_2.webp', 'chambre_rennes_5_3.avif'],
            'description' => [
